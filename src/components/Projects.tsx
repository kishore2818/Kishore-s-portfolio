...
const Projects: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      id: 6,
      title: 'Loading....',
      description: 'Attendance Monitoring System — loading. An AI-powered attendance tracking system using facial recognition for automated student/staff check-ins. Coming soon.',
      image: '/projects/iot.png',
      tech: ['React', 'Python', 'OpenCV', 'Firebase'],
      demoUrl: '#',
      githubUrl: '#',
